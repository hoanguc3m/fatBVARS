///////////////////////////////////////////////////////////////////////////////////////
// This file is borrowed from https://github.com/FK83/bvarsv
///////////////////////////////////////////////////////////////////////////////////////
...
List sigmahelper4(arma::mat y2, arma::colvec qs, arma::colvec ms, arma::colvec u2s, arma::mat Sigtdraw, arma::mat Zs, arma::mat Wdraw, arma::colvec sigma_prmean, arma::mat sigma_prvar){
  //arma::mat y2 = arma::zeros(t,M); // y2 as (u^2)

  double M = y2.n_cols; // dimensions
  ...
  arma::mat vart = arma::zeros(t*M,M); // variance of the mixtures
  arma::mat yss1 = arma::zeros(t,M); // simulation of h = log vol
  for (int i = 1; i < (t+1); i++) {
    for (int j = 1; j < (M+1); j++) {
      double imix = statedraw(i-1,j-1);
      vart(((i-1)*M+j-1),j-1) = u2s(imix-1);
